		...
		mxscript(App.UM_SCRIPT_URL, function () {
			...
			<div class="part loginPart">\
				<form id="login" action="###" method="post" novalidate="novalidate">\
					<div id="register-active" class="switch"><i class="fa fa-toggle-on"></i>'+ mxResources.get('changeReg') + '</div>        <h3>' + mxResources.get('loginIn') + '<p class="status"></p></h3>\
					<p>\
						<label class="icon" for="username"><i class="fa fa-user"></i></label>\
						<input class="input-control" id="username" type="text" placeholder="'+ mxResources.get('inputYourName') + '" name="username" required="" aria-required="true">\
				</p>\
						<p>\
							<label class="icon" for="password"><i class="fa fa-lock"></i></label>\
							<input class="input-control" id="password" type="password" placeholder="'+ mxResources.get('inputYourPassword') + '" name="password" required="" aria-required="true">\
				</p>\
							<p class="safe">\
								...
								<p>\
									...
									<div class="part registerPart">\
										<form id="register" action="?action=register" method="post" novalidate="novalidate">\
											<div id="login-active" class="switch"><i class="fa fa-toggle-off"></i>'+ mxResources.get('changeLogin') + '</div>\
											<h3>'+ mxResources.get('regText') + '<p class="status"></p></h3>\
											<p>\
												<label class="icon" for="user_name"><i class="fa fa-user"></i></label>\
												<input class="input-control" id="user_name" type="text" name="user_name" placeholder="'+ mxResources.get('inputEnglistName') + '" required="" aria-required="true">\
				</p>\
												<p>\
													<label class="icon" for="user_email"><i class="fa fa-envelope"></i></label>\
													<input class="input-control" id="user_email" type="email" name="user_email" placeholder="'+ mxResources.get('inputEmail') + '" required="" aria-required="true">\
				</p>\
													<p>\
														<label class="icon" for="user_pass"><i class="fa fa-lock"></i></label>\
														<input class="input-control" id="user_pass" type="password" name="user_pass" placeholder="'+ mxResources.get('passwrodMinLenText') + '" required="" aria-required="true">\
				</p>\
														<p>\
															<label class="icon" for="user_pass2"><i class="fa fa-retweet"></i></label>\
															<input class="input-control" type="password" id="user_pass2" name="user_pass2" placeholder="'+ mxResources.get('inputPasswordAgain') + '" required="" aria-required="true">\
				</p>\
															<p id="captcha_inline">\
																<input class="input-control inline" type="text" id="um_captcha" name="um_captcha" placeholder="'+ mxResources.get('inputValidCode') + '" required="" aria-required="true">\
																	<img src="/api/UserAuthentication/VCode" class="captcha_img inline" title="'+ mxResources.get('refrashValidCode') + '">\
																		<input class="submit inline" type="submit" value="'+ mxResources.get('regText') + '" name="submit">\
				</p>\
																		<a class="close"><i class="fa fa-times"></i></a>\
			</form>\
		</div>\
